$(function () {
    "use strict";
    // Helper function to safely initialize PerfectScrollbar
    function initPerfectScrollbar(selector) {
        const element = document.querySelector(selector);
        if (element && typeof PerfectScrollbar !== "undefined") {
            new PerfectScrollbar(element);
        } else if (!element) {
            console.log(`Element not found for PerfectScrollbar: ${selector}`);
        } else {
            console.log(
                "PerfectScrollbar is not loaded. Skipping initialization."
            );
        }
    }

    // Initialize PerfectScrollbar for existing elements
    window.initDynamicScrollbars = function () {
        initPerfectScrollbar(".app-container");
        initPerfectScrollbar(".header-message-list");
        initPerfectScrollbar(".header-notifications-list");
    };
    initDynamicScrollbars();
